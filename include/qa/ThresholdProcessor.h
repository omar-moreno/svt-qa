...
#ifndef __THRESHOLD_PROCESSOR_H__
#define __THRESHOLD_PROCESSOR_H__
...
class ThresholdProcessor : public Processor { 
    ...
    public: 
         ...
         */
        ThresholdProcessor(const std::string& name, Process& process); 
    ...
    private: 
        ...
        void addThresholdHistogram(int feb_id, int hybrid_id); 
        ...
        void processThresholdPlot(int feb, int hybrid, TH2S* baseline_plot); 
...
#endif // __THRESHOLD_PRCESSOR_H__
